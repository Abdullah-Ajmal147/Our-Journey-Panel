...
sudo chown -R ubuntu:ubuntu "/home/ubuntu/backend/$PROJECT_MAIN_DIR_NAME"

# Create virtual environment
echo "Creating virtual environment..."
virtualenv "/home/ubuntu/backend/$PROJECT_MAIN_DIR_NAME/venv"

# Activate virtual environment
echo "Activating virtual environment..."
source "/home/ubuntu/backend/$PROJECT_MAIN_DIR_NAME/venv/bin/activate"
